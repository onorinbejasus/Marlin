 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, 15, -1.92 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 30, 205, 205 } // (mm) Left, Front, Right, Back insets
 ...
 *   TFT_GENERIC
 *
 * For 2w, you need to configure these 3 options:
 *   Driver:     TFT_DRIVER
